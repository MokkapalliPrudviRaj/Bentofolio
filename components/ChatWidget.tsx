...
export const ChatWidget: React.FC<{ className?: string }> = ({ className }) => {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: ChatRole.MODEL,
      text: "Hi! I'm Alex's AI assistant. Ask me anything.",
    },
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: ChatRole.MODEL, text: "Oops, connection error." },
      ]);
    } finally {
      setIsTyping(false);
    }
  ...
  return (
    ...
    >
      <div className="flex flex-col h-full bg-white dark:bg-neutral-900">
        ...
        <div
          ref={scrollRef}
          className="flex-grow min-h-fit overflow-y-auto p-3 space-y-3 custom-scrollbar"
        >
